  ...
  - module: Subscription::Config
    config:
      feed:
        ...
        - url: file://$t::TestPlagger::BaseDirURI/t/samples/vimeo.html
          meta:
...
is $context->update->feeds->[1]->entries->[0]->title, "Flip MinoHD Unboxing";
like $context->update->feeds->[1]->entries->[0]->link, qr/2273346/;
